<div class="col-sm-8 conversation">
    @if ($user)
        <div class="row heading">
            ...
            <div class="col-sm-10 col-xs-10 heading-name">
                <a class="heading-name-meta text-decoration-none">{{ $user['name'] }}</a>
                <span class="heading-online">Online</span>
            </div>
            <div class="col-sm-1 col-xs-1 heading-dot pull-right mx-0">
    ...
    @else
        <div class="d-flex h-100">
            <p class="m-auto">please select a member</p>
        </div>
    @endif
</div>
